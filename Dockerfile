...
ARG NEXT_PUBLIC_R2_PUBLIC_BASE_URL_STG
ARG NEXT_PUBLIC_R2_PUBLIC_BASE_URL_PRD
...
ENV NEXT_PUBLIC_R2_PUBLIC_BASE_URL_STG=$NEXT_PUBLIC_R2_PUBLIC_BASE_URL_STG
ENV NEXT_PUBLIC_R2_PUBLIC_BASE_URL_PRD=$NEXT_PUBLIC_R2_PUBLIC_BASE_URL_PRD

RUN set -eu; \
  : "${NEXT_PUBLIC_API_BASE_URL:?required}"; \
  : "${NEXT_PUBLIC_LOGO_URL:?required}"; \
  test -n "${NEXT_PUBLIC_R2_PUBLIC_BASE_URL}${NEXT_PUBLIC_R2_PUBLIC_BASE_URL_STG}${NEXT_PUBLIC_R2_PUBLIC_BASE_URL_PRD}"; \
  npm run build
